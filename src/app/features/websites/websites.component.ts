              ...
              @for (website of websites; track website.id) {
                <tr class="hover:bg-gray-50 transition-colors">
                  <td class="px-6 py-4 whitespace-nowrap">
                    <div class="font-semibold text-gray-900">{{ website.alias }}</div>
                  </td>
                  <td class="px-6 py-4">
                    <div class="text-sm text-gray-600 max-w-md truncate">{{ website.url }}</div>
                  </td>
                  <td class="px-6 py-4 whitespace-nowrap">
          ...
          @for (website of websites; track website.id) {
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4">
              <div class="flex items-start justify-between mb-3">
                <div>
                  <h3 class="font-semibold text-gray-900 mb-1">{{ website.alias }}</h3>
                  ...
                  <div class="flex flex-wrap gap-2">
                    @for (tag of tags; track tag.id) {
                      <button
                        ...
                        [class]="selectedTagIds.has(tag.id) ? 'ring-2 ring-offset-2' : 'opacity-60'"
                        [style.background-color]="tag.color + '20'"
                        [style.color]="tag.color"
                        [style.ring-color]="tag.color"
                        class="inline-flex items-center px-3 py-1.5 rounded-full text-sm font-medium transition hover:opacity-100"
                      >
          ...
          <div class="bg-white rounded-2xl shadow-xl w-full max-w-md" (click)="$event.stopPropagation()">
            <div class="p-6">
              ...
              <p class="text-gray-600 mb-6">
                Are you sure you want to delete <strong>{{ deletingWebsite.alias }}</strong>?
